...
class DingTalkRobotAutomationPlugin(BasePlugin, AutomationProvider):
    plugin_id = "automation.dingtalk_robot"
    plugin_name = "钉钉机器人通知自动化"
...
plugin = DingTalkRobotAutomationPlugin()
