...
class FeishuBotAutomationPlugin(BasePlugin, AutomationProvider):
    plugin_id = "automation.feishu_bot"
    plugin_name = "飞书机器人通知自动化"
...
plugin = FeishuBotAutomationPlugin()
