...
class WebhookAutomationPlugin(BasePlugin, AutomationProvider):
    plugin_id = "automation.webhook"
    plugin_name = "通用 Webhook 通知自动化"
    ...
    def _is_configured(self) -> bool:
        return bool(str(self._runtime_config.get("url") or "").strip())
...
plugin = WebhookAutomationPlugin()
